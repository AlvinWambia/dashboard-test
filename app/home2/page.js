...
async function getData() {
    // Fetch testimonials, about and loungewear from Sanity (programs are fetched from Supabase)
    const query = `{
    ...
    console.log("Attempting to fetch data from Sanity and Supabase for home2...");
    try {
        ...
        console.log(`Successfully fetched data for home2.`);
        return {
            ...sanityData,
